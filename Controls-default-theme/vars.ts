export default {
    ...
    '--secondary_hover_text-color': '#2f5b8e',
    ...
    '--unaccented_hover_icon-color': '#6b6b6b',

    '--unaccented_contrast_background-color': '#9CB3C9',
    '--unaccented_hover_contrast_background-color': '#9CB3C9',
    '--unaccented_active_contrast_background-color': '#9CB3C9',
    ...
    '--success_text-color': '#24a83d',
    '--success_hover_text-color': '#28bd44',
    '--success_icon-color': '#24a83d',
    ...
    '--info_color': '#4745a1',
    '--info_text-color': '#4745a1',
    '--info_hover_text-color': '#7270c2',
    '--info_icon-color': '#4745a1',
    '--info_hover_icon-color': '#7270c2',
    '--info_border-color': '#3d3bbf',
    '--info_background-color': '#f7f7ff',
    '--info_hover_background-color': '#ebebff',
    '--info_active_background-color': '#dcdbff',
    '--info_same_background-color': '#ebebff',
    '--info_hover_same_background-color': '#dcdbff',
    '--info_active_same_background-color': '#cdccff',
    '--info_contrast_background-color': '#5957b7',
    '--info_hover_contrast_background-color': '#4b49a7',
    '--info_active_contrast_background-color': '#444294',
