    ...
    protected _beforeMount(): void {
        this._source = new Memory({
            data: [
                ...
                {key: '3', title: 'Discuss', icon: 'icon-EmptyMessage',
                    addIcon: 'icon-VideoCallNull', template: 'wml!Controls-demo/dropdown_new/Input/ItemTemplateProperty/RightTemplate/ItemTpl'},
