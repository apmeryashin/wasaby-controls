...
import * as Template from 'wml!Controls-demo/treeGridNew/NodeFooter/NodeFooterVisibilityCallback/NodeFooterVisibilityCallback';
...
const navigation: INavigationOptionValue<INavigationSourceConfig> = {
    source: 'page',
    view: 'demand',
    sourceConfig: {
        pageSize: 3,
...
export default class extends Control {
    ...
    protected _navigation: INavigationOptionValue<INavigationSourceConfig> = navigation;
