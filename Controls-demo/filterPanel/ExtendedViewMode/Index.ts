...
import * as Template from 'wml!Controls-demo/filterPanel/ExtendedViewMode/Index';
                ...
                editorOptions: {
                    source: new Memory({
                        ...
                        data:  [
                            {department: 'Разработка', title: 'Разработка'},
                            {department: 'Продвижение СБИС', title: 'Продвижение СБИС'},
                            {department: 'Федеральная клиентская служба', title: 'Федеральная клиентская служба'}
                        ]
                    }),
