...
export default class extends Control {
    ...
    protected _onItemActivate(event: SyntheticEvent, item: Model, parentEvent: SyntheticEvent, target: HTMLElement): void {
        this._activeItem = target ? ('item-key: ' + target.getAttribute('item-key')) : null;
    }
