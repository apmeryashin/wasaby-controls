      ...
      describe('openPopup', function() {
         it('should open opener with default options', function() {
            ...
            sinon.assert.calledWith(component._stickyOpener.open, sinon.match({
               className: 'controls_datePicker_theme-default controls-DatePopup__selector-marginTop_fontSize-m controls-DatePopup__selector-marginLeft controls_theme-default',
               target: TARGET,
               templateOptions: {
         ...
         describe('open dialog with .controls-DatePopup__selector-marginLeft-withoutModeBtn css class', function() {
            [{
               ...
               it(`${JSON.stringify(test)}`, function () {
                  ...
                  component.openPopup();
                  sinon.assert.calledWith(component._stickyOpener.open, sinon.match({
                     className: 'controls_datePicker_theme-default controls-DatePopup__selector-marginTop_fontSize-m controls-DatePopup__selector-marginLeft-withoutModeBtn controls_theme-default'
                  }));
               });
            });
         });
