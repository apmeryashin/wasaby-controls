...
describe('Controls/_baseList/ScrollContainer/VirtualScroll', () => {
    ...
    describe('.removeItems', () => {
        ...
        beforeEach(() => {
            instance = new controller(
                {pageSize: 5, segmentSize: 1},
                {viewport: 200, topTrigger: 10, bottomTrigger: 10, scroll: 300}
            );
            // tslint:disable-next-line:no-magic-numbers
            instance.resetRange(0, 5);
            // tslint:disable-next-line:ban-ts-ignore
    ...
    describe('.shiftRange', () => {
        ...
        const instance = new controller(
            {pageSize: 5, segmentSize: 1},
            {viewport: 200, topTrigger: 60, bottomTrigger: 60, scroll: 240}
        );
    ...
    describe('.isNeedToRestorePosition', () => {
        it('after shift range', () => {
            ...
            const instance = new controller(
                {pageSize: 5, segmentSize: 1},
                {viewport: 200, topTrigger: 10, bottomTrigger: 10, scroll: 600}
            );
            // tslint:disable-next-line:no-magic-numbers
            instance.resetRange(0, 10, {itemsHeights: [60, 60, 60, 60, 60, 60, 60, 60, 60, 60]});
            instance.shiftRange('down');
    ...
    describe('.getDirectionToRestoreScroll()', () => {
        ...
        it('after shift with recalculate indexes to both direction', () => {
            ...
            // tslint:disable-next-line:no-magic-numbers
            const instance = new controller(
                {pageSize: 10, segmentSize: 5},
                {viewport: 3, topTrigger: 1, bottomTrigger: 1, scroll: 30}
            );
            // tslint:disable-next-line:no-magic-numbers
    ...
    describe('.viewResize()', () => {
        ...
        beforeEach(() => {
            ...
            instance = new controller(
                {pageSize: 5, segmentSize: 1},
                {viewport: 200, topTrigger: 10, bottomTrigger: 10, scroll: 200}
            );
        });
    ...
    describe('.viewportResize()', () => {
        ...
        beforeEach(() => {
            ...
            instance = new controller(
                {pageSize: 5, segmentSize: 1},
                {viewport: 200, topTrigger: 60, bottomTrigger: 60, scroll: 300}
            );
        });
