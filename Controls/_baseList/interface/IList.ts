 ...
 * @param {String} [position='top'] Целевое положение элемента коллекции, к которому происходит прокручивание. Если 'bottom', то нижняя граница элемента будет (по возможности) совпадать с нижней границей контейнера. Если 'top', то совпадать будут верхние границы.
