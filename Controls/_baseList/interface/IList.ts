 ...
 * @param {String} [position='top'] Целевое положение элемента коллекции, к которому происходит прокручивание. Если 'top', то нижняя граница элемента будет (по возможности) совпадать с нижней границей контейнера. Если 'bottom', то совпадать будут верхние границы.
