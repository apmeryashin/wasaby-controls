...
export class ListCompatible extends DestroyableMixin {
    ...
    generateCompatibleEvents(listScroll: RegisterClass, scrollModel: ScrollModel, oldScrollState: ScrollState): void {
        ...
        if (scrollModel.canHorizontalScroll !== oldScrollState.canHorizontalScroll) {
            this.sendByListScrollRegistrar(
                listScroll,
                scrollModel.canVerticalScroll ? 'canHorizontalScroll' : 'cantHorizontalScroll',
                {
                    clientWidth: scrollModel.clientWidth,
                    scrollWidth: scrollModel.scrollWidth,
                    viewPortRect: scrollModel.viewPortRect
    ...
    onRegisterNewListScrollComponent(listScroll: RegisterClass, scrollModel: ScrollModel, component: Control): void {
    ...
    private _sendScrollMoveAsync(listScroll: RegisterClass,
                                 scrollModel: ScrollModel,
                                 direction: SCROLL_DIRECTION): void {
    ...
    private _sendByListScrollRegistrarToComponent(listScroll: RegisterClass,
                                                  component: Control,
                                                  eventType: string,
                                                  params: object): void {
