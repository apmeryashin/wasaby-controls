...
import AddingTreeTileItem from 'Controls/_treeTile/display/AddingTreeTileItem';
...
register('Controls/treeTile:AddingTreeTileItem', AddingTreeTileItem, {instantiate: false});
