   ...
   private _getItemSelected(
      ...
      if (item['[Controls/_display/BreadcrumbsItem]']) {
         ...
         if (!this._selectAncestors && !this._selectDescendants) {
            // В этом случае мы вообще не смотри на узлы, т.к. выбранность элемента не зависит
            // от выбора родительского узла или выбранность узла не зависит от его детей
