...
import {IFilterOptions, IHierarchyOptions, ISelectionCountModeOptions, TKey} from 'Controls/interface';
...
export interface IOptions extends IHierarchyOptions, IControlOptions, ISelectionCountModeOptions,
    IBaseControlOptions, IFilterOptions {
...
/**
 * @typedef {String} Controls/_tree/interface/ITree/HierarchyViewModeEnum
 * @variant tree Дерево.
...
/**
 * @name Controls/_tree/interface/ITree#itemTemplate
 ...
 * </Controls.tree:View>
 * </pre>
 * @see Controls/_tree/interface/ITree#itemTemplateProperty
 * @see Controls/tree:ItemTemplate
 */

/**
 * @name Controls/_tree/interface/ITree#itemTemplateProperty
 * @cfg {String} Имя поля элемента, которое содержит Путь к {@link Controls/_tree/interface/ITree#itemTemplate шаблону отображения элемента}. С помощью этой настройки отдельным элементам можно задать собственный шаблон отображения.
 * @remark
 * Если не задано значение в опции itemTemplateProperty или в свойстве элемента, то используется шаблон из {@link Controls/_tree/interface/ITree#itemTemplate itemTemplate}.
 * @see Controls/_tree/interface/ITree#itemTemplate
 */

/**
 * @name Controls/_tree/interface/ITree#expandByItemClick
...
/**
 * @name Controls/_tree/interface/ITree#collapsedItems
 ...
 * This option is used only when the value of {@link Controls/_tree/interface/ITree#expandedItems expandedItems} is [null].
...
/**
 * @name Controls/_tree/interface/ITree#nodeFooterTemplate
...
/**
 * @name Controls/_tree/interface/ITree#nodeMoreCaption
...
/**
 * @name Controls/_tree/interface/ITree#nodeFooterVisibilityCallback
...
/**
 * @name Controls/_tree/interface/ITree#hasChildrenProperty
...
/**
 * @name Controls/_tree/interface/ITree#searchBreadCrumbsItemTemplate
...
/**
 * @typedef {String} Controls/_tree/interface/ITree/ExpanderVisibility
...
/**
 * @name Controls/_tree/interface/ITree#expanderVisibility
 * @cfg {Controls/_tree/interface/ITree/ExpanderVisibility.typedef} Режим отображения {@link /doc/platform/developmentapl/interface-development/controls/list/tree-column/node/expander/ кнопки-экспандера} в {@link Controls/treeGrid:View дереве с колонками}.
 * @default visible
...
/**
 * @name Controls/_tree/interface/ITree#expanderPosition
...
/**
 * @name Controls/_tree/interface/ITree#nodeLoadCallback
...
/**
 * @name Controls/_tree/interface/ITree#deepReload
...
/**
 * @name Controls/_tree/interface/ITree#selectAncestors
...
/**
 * @name Controls/_tree/interface/ITree#selectDescendants
...
/**
 * @name Controls/_tree/interface/ITree#markItemByExpanderClick
...
/**
 * @typedef {String} Controls/_tree/interface/ITree/TOffset
...
/**
 * @name Controls/_tree/interface/ITree#expanderSize
...
/**
 * @name Controls/_tree/interface/ITree#expanderIcon
...
/**
 * @name Controls/_tree/interface/ITree#singleExpand
...
/**
 * @name Controls/_tree/interface/ITree#getMarkedNodeKey
...
/**
 * @name Controls/_tree/interface/ITree#source
 ...
 * @name Controls/_tree/interface/ITree#afterItemExpand
 ...
 * @name Controls/_tree/interface/ITree#beforeItemExpand
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
...
/**
 * @event Происходит перед развертыванием узла.
 * @name Controls/_tree/interface/ITree#itemExpand
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Types/entity:Model} node Разворачиваемый узел.
 * @remark
 * Что такое "узел" читайте в {@link /doc/platform/developmentapl/service-development/bd-development/vocabl/tabl/relations/#hierarchy руководстве разработчика}.
 * @deprecated Событие устарело и в ближайшее время его поддержка будет прекращена. Используте {@link Controls/_tree/interface/ITree#beforeItemExpand beforeItemExpand}.
 */

/**
 * @event Происходит после развертывания узла.
 * @name Controls/_tree/interface/ITree#itemExpanded
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Types/entity:Model} node Развёрнутый узел.
 * @remark
 * Что такое "узел" читайте в {@link /doc/platform/developmentapl/service-development/bd-development/vocabl/tabl/relations/#hierarchy руководстве разработчика}.
 * @deprecated Событие устарело и в ближайшее время его поддержка будет прекращена. Используте {@link Controls/_tree/interface/ITree#afterItemExpand afterItemExpand}.
 */
 ...
 * @name Controls/_tree/interface/ITree#afterItemCollapse
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
 ...
 * @name Controls/_tree/interface/ITree#itemCollapse
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Types/entity:Model} node Сворачиваемый узел.
 * @remark
 * Что такое "узел" читайте в {@link /doc/platform/developmentapl/service-development/bd-development/vocabl/tabl/relations/#hierarchy руководстве разработчика}.
 * @deprecated Событие устарело и в ближайшее время его поддержка будет прекращена. Используте {@link Controls/_tree/interface/ITree#beforeItemCollapse beforeItemCollapse}.
 */

/**
 * @event Происходит перед сворачиванием узла.
 * @name Controls/_tree/interface/ITree#beforeItemCollapse
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Types/entity:Model} node Сворачиваемый узел.
 * @remark
...
/**
 * @event Происходит после сворачивания узла.
 * @name Controls/_tree/interface/ITree#itemCollapsed
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Types/entity:Model} node Свёрнутый узел.
 * @remark
 * Что такое "узел" читайте в {@link /doc/platform/developmentapl/service-development/bd-development/vocabl/tabl/relations/#hierarchy руководстве разработчика}.
 * @deprecated Событие устарело и в ближайшее время его поддержка будет прекращена. Используте {@link Controls/_tree/interface/ITree#afterItemCollapse afterItemCollapse}.
 */
 ...
 * @name Controls/_tree/interface/ITree#collapsedItemsChanged
 * @param {UICommon/Events:SyntheticEvent} eventObject Дескриптор события.
