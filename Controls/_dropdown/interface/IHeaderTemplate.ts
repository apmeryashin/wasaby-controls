...
/**
 * @name Controls/_dropdown/interface/IHeaderTemplate#headerCaptionProperty
 * @cfg {String} Название свойства, которое содержит заголовок шапки для подменю.
 * @demo Controls-demo/dropdown_new/Button/HeaderCaptionProperty/Index
 * @example
 ...
 *    nodeProperty="@parent"
 *    headerCaptionProperty="headerCaption"
 *    source="{{_source}}">
 * </Controls.dropdown:Button>
 * </pre>
 * <pre class="brush: js;">
 ...
 *       data: [{ key: 1, title: 'Task', '@parent': true, parent: null },
                ...
                { key: 4, title: 'Coordination', parent: 1, '@parent': true, headerCaption: 'Node header caption' }
 *       ],
 *       keyProperty: 'key'
 *    });
 * }
